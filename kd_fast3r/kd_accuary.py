...
class Evaluator:
    ...
    def print_summary(self, results: Dict):
        ...
        print(f"\n1. Chamber Distance: {chamber['chamber_distance']:.6f}")
        ...
        print(f"\n2. Point-wise L2 Distance: {l2['mean_l2_distance']:.6f}")
        ...
        print(f"\n3. Per-axis MAE: {mae['overall_mae']:.6f}")
        ...
        print(f"\n4. Self-consistency: {consistency['self_consistency_score']:.4f}")
