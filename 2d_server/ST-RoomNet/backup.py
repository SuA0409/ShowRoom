...
# image 불러오기
val_path = '/content/drive/MyDrive/Final_Server/Input/Images' #chrome extention에서 저장한 이미지
...
# pose 불러오기
pose_path = '/content/drive/MyDrive/Final_Server/Input/Poses/poses.txt'
...
ref_img_path = '/content/drive/MyDrive/Final_Server/2d/discriminator/ref_img2.png'
...
weight_path = '/content/drive/MyDrive/Final_Server/2d/discriminator/weights/Weight_ST_RroomNet_ConvNext.h5'
...
save_path = '/content/drive/MyDrive/Final_Server/Input/ST'
